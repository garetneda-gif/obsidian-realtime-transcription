...
export type CloudProviderPreference = "auto" | "tencent" | "deepgram";
export type CloudLanguage = "auto" | "zh-CN" | "zh-HK" | "en" | "ja" | "ko";

export const HOSTED_CLOUD_ENABLED = true;
...
export interface TencentCloudAsrSession extends CloudAsrSessionBase {
  provider: "tencent";
  auth_type: "signed_url";
  signed_url: string;
}

export interface DeepgramCloudAsrSession extends CloudAsrSessionBase {
  provider: "deepgram";
  auth_type: "proxy";
  proxy_token: string;
  expires_in: number;
...
export type CloudAsrSession = TencentCloudAsrSession | DeepgramCloudAsrSession;
...
export interface PluginSettings {
  ...
  cloudProvider: CloudProviderPreference;
